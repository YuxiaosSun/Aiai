...
//        selectedDate.backgroundColor=[UIColor grayColor];
        selectedDate.font=[UIFont systemFontOfSize:14];
    }
...
//        totalDays.backgroundColor=[UIColor yellowColor];
        totalDays.font=[UIFont systemFontOfSize:16];
