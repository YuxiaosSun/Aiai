...
//    testCode.clearButtonMode =UITextFieldViewModeWhileEditing;
    ...
    testCode.font = [UIFont systemFontOfSize:font];
    ...
    phoneNum.font = [UIFont systemFontOfSize:font];
...
//    NSLog(@"avgSpace:%f",avgSpace);
    ...
    //qq
    UIButton *qqImgV = [UIButton new];
//    qqImgV.backgroundColor = [UIColor blueColor];
    [qqImgV setBackgroundImage:[UIImage imageNamed:@"qq_quick"] forState:UIControlStateNormal];
    
    
    //微信
    UIButton *wechatImgV = [UIButton new];
//    wechatImgV.backgroundColor = [UIColor grayColor];
    [wechatImgV setBackgroundImage:[UIImage imageNamed:@"wechat_quick"] forState:UIControlStateNormal];
    
    
    //微博
    UIButton *weiboImgV = [UIButton new];
//    weiboImgV.backgroundColor = [UIColor purpleColor];
    [weiboImgV setBackgroundImage:[UIImage imageNamed:@"weibo_quick"] forState:UIControlStateNormal];
    
    
    NSArray *viewsArr = @[qqImgV,wechatImgV,weiboImgV];
    ...
    wechatImgV.sd_layout
    .leftSpaceToView(qqImgV, avgSpace)
    .topEqualToView(qqImgV)
    .heightEqualToWidth()
    ;
    ...
    //添加点击事件
    [qqImgV addTarget:self action:@selector(qqLogin:) forControlEvents:UIControlEventTouchUpInside];
    [wechatImgV addTarget:self action:@selector(wechatLogin:) forControlEvents:UIControlEventTouchUpInside];
    [weiboImgV addTarget:self action:@selector(sinaLogin:) forControlEvents:UIControlEventTouchUpInside];
