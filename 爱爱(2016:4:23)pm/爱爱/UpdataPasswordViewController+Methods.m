...
//    getTestCode.layer.shadowOpacity =0.3;
    ...
    [noticeLabel setFont:[UIFont boldSystemFontOfSize:14]];
...
//    updataBtn.layer.shadowOpacity=0.5;
    ...
    [otherBtn setTitle:@"其它方法" forState:UIControlStateNormal];
    [otherBtn.titleLabel setFont:[UIFont boldSystemFontOfSize:14]];
    ...
    [otherBtn sizeToFit];
    otherBtn.frame=CGRectMake(Width-20-20-otherBtn.frame.size.width, updataBtn.frame.origin.y+updataBtn.frame.size.height+lineSpace, otherBtn.frame.size.width, otherBtn.frame.size.height);
