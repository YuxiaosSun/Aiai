...
-(void)creatView
{
    ...
    _titleLabel.dk_textColorPicker=DKColorWithColors([UIColor blackColor], TitleTextColorNight);
    ...
    _publishTime.dk_textColorPicker=DKColorWithColors(RGBA(100, 100, 100, 1), UnimportantContentTextColorNight);
