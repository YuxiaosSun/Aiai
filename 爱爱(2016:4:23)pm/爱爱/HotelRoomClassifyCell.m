...
-(void)setupView    //加载视图
{
    ...
    [_backImage zy_cornerRadiusAdvance:5.0f rectCornerType:UIRectCornerAllCorners];
    ...
    self.introduction.font=[UIFont systemFontOfSize:18];
...
//    NSLog(@"imageUrl:%@",imageUrl);
    ...
    //设置图片
    [self.backImage sd_setImageWithURL:[NSURL URLWithString:imageUrl] placeholderImage:nil AndProgressBackgroundColor:MainThemeColor AndProgressTintColor:[UIColor whiteColor] AndSize:CGSizeMake(0, 0)];
